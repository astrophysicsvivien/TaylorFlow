...
def getwaveform(mass1,mass2,frequencies=None,LuminosityDistance=1.,t_c=0,phi_c=0.,f_low=10.,
               df=0.1,f_high=1600.,phase_order=0):
    """
    ...
    return frequencies.numpy(), waveform